...
const Order = ({ order, handleDelete }) => {
    const { _id, orderId, partsName, Quantity, email, price } = order;
    return (
        <div className="card lg:max-w-lg bg-base-100 shadow-xl">
            ...
            <div className='w-2/4 mx-auto'>
                <button className="btn btn-primary uppercase text-white font-bold mb-4 " onClick={() => handleDelete(_id)}>Delete</button>
            </div>
        </div>
    );
};
